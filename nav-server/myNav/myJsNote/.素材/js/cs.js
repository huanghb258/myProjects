...
function OpenWindow(n, t, i, r) {
    var u = (screen.width - t) / 2 - r, f = (screen.height - i) / 2 - r, e = window.open(n, "_blank", "width=" + t + ",height=" + i + ",toolbars=0,resizable=1,left=" + u + ",top=" + f);
    e.focus()
}
function hide_links() {
...
function PutInWz() {
    var n = 480, t = 360, i = (screen.width - n) / 2, r = (screen.height - t) / 2, u = document, f = document.getElementsByTagName("title")[0].innerHTML;
...
function logout() {
    return confirm("ȷ���˳���") && (location.href = "https://passport.cnblogs" + getHostPostfix() + "/logout.aspx?ReturnUrl=" + location.href), !1
}
function register() {
...
function cb_CodeHighlight() {
    ...
    }), n) && (SyntaxHighlighter.autoloader.apply(null, shBushPathPrepare("applescript\t\t\t    @shBrushAppleScript.javascripts", "actionscript3 as3\t\t@shBrushAS3.javascripts", "bash shell\t\t\t\t@shBrushBash.javascripts", "coldfusion cf\t\t\t@shBrushColdFusion.javascripts", "cpp c\t\t\t\t\t@shBrushCpp.javascripts", "c# c-sharp csharp\t\t@shBrushCSharp.javascripts", "stylesheets\t\t\t\t\t    @shBrushCss.javascripts", "delphi pascal pas\t\t@shBrushDelphi.javascripts", "diff patch       \t\t@shBrushDiff.javascripts", "erl erlang\t\t\t\t@shBrushErlang.javascripts", "groovy\t\t\t\t\t@shBrushGroovy.javascripts", "java\t\t\t\t\t    @shBrushJava.javascripts", "jfx javafx\t\t\t\t@shBrushJavaFX.javascripts", "javascripts jscript javascript\t@shBrushJScript.javascripts", "perl pl Perl\t\t\t\t@shBrushPerl.javascripts", "php\t\t\t\t\t    @shBrushPhp.javascripts", "text plain\t\t\t\t@shBrushPlain.javascripts", "py python\t\t\t\t@shBrushPython.javascripts", "ruby rails ror rb\t\t@shBrushRuby.javascripts", "sass scss\t\t\t\t@shBrushSass.javascripts", "scala\t\t\t\t\t@shBrushScala.javascripts", "sql\t\t\t\t\t    @shBrushSql.javascripts", "vb vbnet\t\t\t\t    @shBrushVb.javascripts", "xml xhtml xslt html\t    @shBrushXml.javascripts?id=20150508", "objc obj-c               @shBrushObjectiveC.javascripts", "f# f-sharp fsharp        @shBrushFSharp.javascripts", "xpp dynamics-xpp         @shBrushDynamics.javascripts", "r s splus                @shBrushR.javascripts", "matlab                   @shBrushMatlab.javascripts", "swift                    @shBrushSwift.javascripts", "go golang                @shBrushGo.javascripts", "mathematica              @shBrushMathematica.javascripts")), SyntaxHighlighter.config.strings.expandSource = "+ View Code", SyntaxHighlighter.vars.discoveredBrushes = null, SyntaxHighlighter.defaults["auto-links"] = !1, SyntaxHighlighter.defaults["quick-code"] = !1, SyntaxHighlighter.all())
}
function cb_mathjax_render() {
    if (cb_enable_mathjax) {
        var t = document.getElementsByTagName("head")[0], n;
        n = document.createElement("script");
        n.type = "text/x-mathjax-config";
        n[window.opera ? "innerHTML" : "text"] = "MathJax.Hub.Config({\n  tex2jax: { inlineMath: [['$','$'], ['\\\\(','\\\\)']] },\n  TeX: { equationNumbers: { autoNumber: ['AMS'], useLabelIds: true }, extensions: ['extpfeil.javascripts'] },\n  'HTML-CSS': { linebreaks: { automatic: true } },\n  SVG: { linebreaks: { automatic: true } }});";
        t.appendChild(n);
        n = document.createElement("script");
        n.type = "text/javascript";
        n.src = location.protocol + "//mathjax.cnblogs.com/2_6_1/MathJax.javascripts?config=TeX-AMS-MML_HTMLorMML";
        t.appendChild(n)
    }
}
function votePost(n, t, i) {
    if (!n) {
        $("#digg_tips").html("�Ƽ�������postId����ȷ");
        return
    }
    i || (i = !1);
    var r = {blogApp: currentBlogApp, postId: n, voteType: t, isAbandoned: i};
    $("#digg_tips").css("color", "red").html("�ύ��...");
    $.ajax({
        ...
        error: function (n) {
            n.status > 0 && (n.status == 500 ? $("#digg_tips").html("��Ǹ�������˴����鷳������contact@cnblogs.com") : $("#digg_tips").html(n.responseText))
        }
    })
}
...
function voteComment(n, t, i) {
    if (!n) {
        $(i).css("color", "red").html("�Ƽ�����commentId����ȷ");
        return
    }
    ...
    return $(i).html($(i).html().replace(/\d+/g, function (n) {
        ...
        data: JSON.stringify(r),
        success: function (n) {
            n.IsSuccess || (n.Message ? $(i).css("color", "red").html(n.Message) : $(i).css("color", "red").html("��Ǹ�������˴����鷳������contact@cnblogs.com"))
        },
        error: function (n) {
            n.status > 0 && (n.status == 500 ? $(i).css("color", "red").html("��Ǹ�������˴����鷳������contact@cnblogs.com") : $(i).css("color", "red").html(n.responseText))
        }
    }), !1
}
...
function CancelCommentEdit() {
    confirm("ȷ��ȡ���޸���") && ResetCommentBox()
}
function ResetCommentBox() {
    $("#btn_comment_submit").val("�ύ");
...
function OnUpdateComment(n) {
    var r, t, i;
    n ? (r = $("#comment_edit_id").html(), t = $("#tbCommentBody").val(), t = escapeHTML(t), t = t.replace(/\n/g, "<br/>"), t = t.replace(/\[quote\]/g, '<fieldset class="comment_quote"><legend>����<\/legend>'), t = t.replace(/\[\/quote\]/g, "<\/fieldset>"), $("#comment_body_" + r).html(t + " <span style='color:red'>�޸ĳɹ���<\/span>"), i = location.href, i.indexOf("#") > 0 && (i = i.substring(0, i.indexOf("#"))), location.href = i + "#" + r, ResetCommentBox(), ShowCommentMsg("�޸ĳɹ���")) : alert("�޸�ʧ�ܣ�")
}
...
function insertUbbUrl(n) {
    var i = prompt("��ʾ���ӵ��ı�.\n���Ϊ�գ���ô��ֻ��ʾ�������ӵ�ַ", ""), t;
    i != null && (t = prompt("http:// ��������", "http://"), t != "" && t != "http://" && (i != "" ? $("#" + n).parseHtml("[url=" + t + "]" + i + "[/url]") : $("#" + n).parseHtml("[url]" + t + "[/url]")))
}
function insertUbbImg(n) {
    var t = prompt("���Ƚ�ͼƬ�ϴ�������ͼ���У�Ȼ��ͼƬ��ַ����ճ���ڴˣ�", "http://");
...
function fix_code_collapse_img(n) {
    if (IsCodeCollapseNode(n.id, "_Open_Image")) {
        var t = n.id.replace("_Open_Image", "_Closed_Image"), i = n.id.replace("_Open_Image", "_Open_Text"), r = n.id.replace("_Open_Image", "_Closed_Text");
        n.onclick = function () {
            $(this).hide();
            $("#" + t + "").show();
            $("#" + i + "").hide();
        ...
        var t = n.id.replace("_Closed_Image", "_Open_Image"), i = n.id.replace("_Closed_Image", "_Open_Text"), r = n.id.replace("_Closed_Image", "_Closed_Text");
        n.onclick = function () {
            $(this).hide();
            $("#" + t + "").show();
            $("#" + i + "").show();
...
function showRemoveLineNumber(n) {
    $(n).append('<div class="cnblogs_code_toolbar"><span class="cnblogs_code_copy"><a href="javascript:void(0);" onclick="removeLineNumber(this);return false;">�����к�<\/a><\/span>')
}
function showCopyCode(n) {
    if ($(n).height() > 120) {
        var t = '<div class="cnblogs_code_toolbar"><span class="cnblogs_code_copy"><a href="javascript:void(0);" onclick="copyCnblogsCode(this)" title="���ƴ���"><img src="//common.cnblogs.com/images/copycode.gif" alt="���ƴ���"/><\/a><\/span>';
        $(n).prepend(t).append(t)
    }
}
function removeLineNumber(n) {
    var t = $(n).parent().parent().parent(), i = $(t).html().replace(/<span style=\"color: #008080;?\">\s*(&nbsp;)?(\d+)<\/span>/gi, "");
    $(t).html(i)
}
function loadEncoderJs() {
    var n = document.createElement("script"), t;
    n.type = "text/javascript";
    n.src = location.protocol + "//common.cnblogs.com/script/encoder.javascripts";
...
function copyCnblogsCode(n) {
    ...
    $(i).html(t);
    $(t).select();
    $("<div>�� Ctrl+C ���ƴ���<\/div>").insertBefore($(t));
    $("<div>�� Ctrl+C ���ƴ���<\/div>").insertAfter($(t))
}
...
function showRunCode(n) {
    ...
    t.length && $(t).append('<span class="cnblogs_code_runjs"><a href="javascript:void(0);" onclick="runJsCode(this)">���д���<\/a><\/span>')
}
...
function GetPrevNextPost(n, t, i) {
    $.get("/post/prevnext", {postId: n, blogId: t, dateCreated: i}, function (n) {
...
function tsina_a() {
    var n = screen, t = document, i = encodeURIComponent, r = "http://v.t.sina.com.cn/share/share.php?", u = t.location.href, f = ["url=", i(u), "&title=", i(t.title)].join("");
...
function outFromAggHome() {
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        success: function (n) {
            n && $("#site_editor_opt").html("<span style='color:red'>�����ɹ���<\/span>")
        }
    })
}
...
function loadPageBeginHtml() {
    currentBlogApp && $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        success: function (n) {
            n && (n.indexOf("<script") > -1 ? $.getScript(location.protocol + "//common.cnblogs.com/script/jquery.writeCapture-min.javascripts", function () {
...
function loadBlogNews() {
    $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && (n.indexOf("<script") < n.indexOf("<script>getFollowStatus") ? $.getScript(location.protocol + "//common.cnblogs.com/script/jquery.writeCapture-min.javascripts", function () {
                $("#blog-news").writeCapture().html(n).show()
            }) : n.indexOf("������ʾ���������쳣") < 0 && $("#blog-news").html(n).show())
        }
    })
}
...
function blogCommentManager() {
    ...
    var n = function (n) {
        ...
        if (!allowComments) {
            $("#comment_form_container").html("�����۹����ѱ����ã�");
            return
        }
        var t = {};
        t.postId = cb_entryId;
        t.blogApp = currentBlogApp;
        $("#comment_form_container").html('<span style="color:green">Ŭ���������ۿ���...<\/span>');
        $.ajax({
            ...
            error: function () {
                $("#comment_form_container").html("<span style='color:red'>���ۿ����ʧ�ܣ��������Ա��ϵ(contact@cnblogs.com)��<\/span>")
            }
        })
    };
    this.postComment = function () {
        $("#btn_comment_submit").val() == "�޸�" && $("#comment_edit_id").html != "" ? commentManager.UpdateComment() : commentManager.PostNewComment()
    };
    ...
    this.PostNewComment = function () {
        ...
        $.ajax({
            ...
            timeout: 3e4,
            success: function (n) {
                if (n)n.IsSuccess ? (ShowCommentMsg("��л���Ļظ�:) ��������ִ�к�ʱ" + n.Duration + "����"), $("#tbCommentBody").val(""), $("#divCommentShow").html($("#divCommentShow").html() + n.Message)) : ShowCommentMsg(n.Message), $("#btn_comment_submit").removeAttr("disabled"); else ShowCommentMsg("��Ǹ�������ύʧ�ܣ��������Ա��ϵ(contact@cnblogs.com)��"), $("#btn_comment_submit").removeAttr("disabled")
            },
            error: function (n, t) {
                n.status == 500 ? ShowCommentMsg("��Ǹ�������˴����鷳������contact@cnblogs.com") : n.status > 0 ? ShowCommentMsg("��Ǹ�������ύʧ�ܣ�������Ϣ��" + n.responseText) : ShowCommentMsg("��Ǹ�������ύʧ�ܣ�����ԭ��" + t);
    ...
    this.UpdateComment = function () {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf8",
            success: function (t) {
                if (t)t.IsSuccess ? (ShowCommentMsg("�޸ĳɹ�"), $("#comment_body_" + n.commentId).html(t.Message), commentManager.ResetCommentBox()) : ShowCommentMsg(t.Message); else ShowCommentMsg("��Ǹ�������޸�ʧ�ܣ��������Ա��ϵ(contact@cnblogs.com)��")
            },
            error: function (n) {
                ShowCommentMsg("��Ǹ�������޸�ʧ�ܣ�������Ϣ��" + n.responseText)
            }
        })
    };
    this.Subscribe = function () {
        if (confirm("ȷ�϶����𣿶��ĺ���������ʱ���ʼ�֪ͨ��")) {
            var n = cb_entryId, t = cb_blogId;
            $("#commentbox_opt_sub").html("�ύ��...");
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf8",
                success: function (n) {
                    n ? $("#commentbox_opt_sub").html("���ĳɹ�") : $("#commentbox_opt_sub").html("����ʧ��")
                }
            })
        }
    };
    this.Unsubscribe = function () {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf8",
            success: function (n) {
                n ? $("#commentbox_opt_unsub").html("ȡ�����ĳɹ�") : $("#commentbox_opt_unsub").html("ȡ������ʧ��")
            }
        })
    };
    ...
    this.loadMailSubscribeOperation = function () {
        $("#commentbox_opt").append('<a href="">���Ļظ�<\/a>')
    };
    this.renderComments = function (r, u, f) {
        ...
        $("#blog-comments-placeholder").html('<div style="color:green;margin:50px 0;font-weight:bold;">Ŭ������������...<\/div>');
        ...
        $.ajax({
            ...
            error: function (n) {
                n.status > 0 && $("#blog-comments-placeholder").html("��Ǹ�������˴����鷳������contact@cnblogs.com")
            }
        })
    }
}
function SubscribeComment() {
    return $("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>���Ĳ�����...<\/span>"), AjaxPost("/ws/CommentService.asmx/SubscribeComment", "{entryId:" + cb_entryId + ",blogId:" + cb_blogId + "}", OnSubscribeSuccess), !1
}
function OnSubscribeSuccess(n) {
    n ? ($("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>���ĳɹ�<\/span>"), $("#<%= lnkSubscribe.ClientID %>").removeAttr("href"), $("#<%= lnkSubscribe.ClientID %>").removeAttr("onclick")) : $("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>����ʧ��<\/span>")
}
function CancelCommentSubscribe() {
    return $("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>ȡ��������...<\/span>"), AjaxPost("/ws/CommentService.asmx/CancelCommentSubscribe", "{entryId:" + cb_entryId + "}", OnCancelSubscribeSuccess), !1
}
function OnCancelSubscribeSuccess(n) {
    n ? ($("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>ȡ���ɹ�<\/span>"), $("#<%= lnkSubscribe.ClientID %>").removeAttr("href"), $("#<%= lnkSubscribe.ClientID %>").removeAttr("onclick")) : $("#<%= lnkSubscribe.ClientID %>").html("<span style='color:red'>ȡ������ʧ��<\/span>")
}
function RefreshCommentList() {
    return $("#tip_comment").html(""), $("#span_refresh_tips").show(), $("#span_refresh_tips").html("����ˢ��..."), $("#span_refresh_tips").css("color", "red"), $("#lnk_RefreshComments").hide(), comment_maxDate || (comment_maxDate = $("#post-date").html()), loadNewComments(cb_entryId, comment_maxDate, comment_maxId), !1
}
...
function QuoteComment(n, t) {
    return $("#tip_comment").html("���ڼ�����������..."), $("#span_parentcomment_id").html(n), $("#span_comment_replyto").html(t), GetQuoteComment(n), !1
}
function GetQuoteComment(n) {
    ...
    $("#tbCommentBody").focus();
    $.getScript(location.protocol + "//common.cnblogs.com/script/encoder.javascripts", function () {
...
function GetCommentBody(n) {
    return ShowCommentMsg("�������ݼ�����..."), $.ajax({
        url: "/mvc/comment/GetCommentBody.aspx",
        type: "post",
        data: '{"commentId":' + n + "}",
        dataType: "text",
        success: function (t) {
            t && ($("#comment_edit_id").html(n), $("#tbCommentBody").focus(), $("#tbCommentBody").val(t), $("#btn_comment_submit").val("�޸�"), $("#span_comment_canceledit").css("display", "inline"));
            ShowCommentMsg("")
        }
    }), !1
}
function DelComment(n, t) {
    return confirm("ȷ��Ҫɾ����������?") && (currentDelElement = t, currentCommentID = n, $(currentDelElement).html("<span style='color:red'>����ɾ��...<\/span>"), $(currentDelElement).removeAttr("href"), $(currentDelElement).removeAttr("onclick"), $.ajax({
        url: "/mvc/comment/DeleteComment.aspx",
        type: "post",
        data: JSON.stringify({commentId: currentCommentID, pageIndex: commentManager.getCurrentPage()}),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (n) {
            n ? ($("#comment_body_" + currentCommentID).html(""), document.getElementById("comment_anchor_" + currentCommentID) != null && (document.getElementById("comment_anchor_" + currentCommentID).parentNode.innerHTML = ""), currentDelElement.parentNode != null && (currentDelElement.parentNode.innerHTML = "<span style='color:red'>ɾ���ɹ�!<\/span>")) : $(currentDelElement).html("ɾ��ʧ�ܣ�")
        }
    })), !1
}
function showImages(n) {
    ...
    try {
        ...
        $(i).each(function () {
            var n = this.src, f = /\.cnblogs\.com|\.cnitblog\.com|\.csdn\.net|\.codecogs\.com|\.360buyimg\.com|www\.forkosh\.com|\.clouddn\.com/.test(n), e = n.indexOf("http") == 0, i, r, u;
...
function canShowAdsense() {
    ...
    if (n.length) {
        var t = n.html(), i = ["�ƽ�", "���к�", "crack", "����", "����", "keygen", "���򹤳�", "ע��", "������", "��Կ"].filter(function (n) {
...
function getBlogPostBody(n) {
    $.ajax({
        ...
        dataType: "text",
        success: function (t) {
            t ? ($("#postlist_postbody_" + n).html(t), cb_CodeHighlight(), cb_mathjax_render(), fixPostListBodyFormat(), n > 3861237 && $.getScript(location.protocol + "//common.cnblogs.com/highlight/9.1.0/highlight.min.javascripts?id=20160127", function () {
...
function google_ga() {
    try {
        google_analytics(window, document, "script", "https://www.google-analytics.com/analytics.javascripts", "ga");
...
function deliverGoogleAdC1() {
    $("#cnblogs_c1").html('<script async src="//pagead2.googlesyndication.com/pagead/javascripts/adsbygoogle.javascripts"><\/script>     <ins class="adsbygoogle"     style="display:inline-block;width:300px;height:250px"     data-ad-client="ca-pub-4210569241504288"     data-ad-slot="5457903683"><\/ins><script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script>')
}
...
function shareOnWechat() {
    var i = document.location.href, n = 420, t = 330, r = (window.screen.availHeight - 30 - t) / 2, u = (window.screen.availWidth - 10 - n) / 2;
...
function follow(n) {
    loadLink(location.protocol + "//common.cnblogs.com/scripts/artDialog/ui-dialog.css", function () {
        loadScript(location.protocol + "//common.cnblogs.com/scripts/artDialog/dialog-min.javascripts", function () {
            if (!isLogined) {
                login();
                return
            }
            if (c_has_follwed) {
                var t = dialog({content: "���Ѿ���ע���ò�����"});
                return t.show(), setTimeout(function () {
                    t.close().remove()
                }, 2e3), !1
            }
            n || (n = cb_blogUserGuid);
            $("#author_profile_follow").html("<span class='color:red'>���ڴ�����...<\/span>");
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                success: function (t) {
                    t == "δ��¼" ? login() : (showFollowMsg(t), t == "��ע�ɹ�" && followByGroup(n, !0))
                },
                error: function (n) {
                    n.status > 0 && showFollowMsg("��Ǹ�������˴����鷳������contact@cnblogs.com")
                }
            })
        })
    })
...
function followByGroup(n, t) {
    loadScript(location.protocol + "//common.cnblogs.com/scripts/artDialog/dialog-plus-min.javascripts", function () {
...
function unfollow(n) {
    loadLink(location.protocol + "//common.cnblogs.com/scripts/artDialog/ui-dialog.css", function () {
        loadScript(location.protocol + "//common.cnblogs.com/scripts/artDialog/dialog-min.javascripts", function () {
            var t = dialog({
                title: "ȡ����ע", content: "��ȷ��Ҫȡ����ע��", okValue: "����ע��", ok: function () {
                    $("#author_profile_follow").html("<span style='color:red'>���ڴ�����...<\/span>");
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        success: function (n) {
                            n == "δ��¼" ? login() : showFollowMsg(n)
                        },
                        error: function (n) {
                            n.status > 0 && showFollowMsg("��Ǹ�������˴����鷳������contact@cnblogs.com")
                        }
                    })
                }, cancelValue: "�ٿ���һ��", cancel: function () {
                }
            });
            t.show()
        })
...
$.fn.extend({
    selection: function () {
        ...
        if (t)this.get(0).focus(), t.selection.createRange().collapse, this.get(0).document.selection.createRange().text = n; else if (this.get(0).selectionStart || this.get(0).selectionStart == "0") {
            var r = this.get(0).selectionStart, u = this.get(0).selectionEnd, i = this.get(0).value, f = i.substring(0, r), e = i.substring(u);
...
insertUBB = function (n, t) {
    var r = $("#" + n).selection(), i;
    r == "" ? $("#tip_comment").html("��ѡ������") : (i = t, t.indexOf("=") >= 0 && (i = t.substring(0, t.indexOf("="))), $("#" + n).parseHtml("[" + t + "]" + r + "[/" + i + "]"))
};
$(function () {
